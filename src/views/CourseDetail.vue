    ...
    <div class="main">
      <div class="course-info">
        ...
        <div class="wrap-right">
          <h3 class="course-name" @click="check_name">{{ course.name }}</h3>
          <p class="data">{{
              course.students
            }}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：{{ course.lessons }}课时/{{ course.students }}小时&nbsp;&nbsp;&nbsp;&nbsp;难度：初级</p>
          <div class="sale-time">
        ...
        <div class="course-tab-list">
          ...
          <div class="tab-item" v-if="tabIndex==2">
            <div class="tab-item-title">
              ...
              <p class="chapter-length">共{{ chapter_list.lenght }}章 75个课时</p>
            </div>
            <div class="chapter-item" v-for="(chapter, key) in chapter_list" :key="key">
    ...
    tabIndex(data) {
      if (data == 2) {
        ...
        this.$axios.get(`${this.$settings.Host}/courses/chapters/?course=${this.course_id}`).then(response => {
          ...
          console.log(129,this.chapter_list)
        }).catch(error => {
